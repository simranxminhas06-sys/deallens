...
VERDICT_COLOR = {
    "proceed": RGBColor(0x00, 0xD0, 0x84),
    "proceed_with_conditions": RGBColor(0xFF, 0xB8, 0x00),
    "further_diligence": RGBColor(0x8C, 0x5C, 0xFF),
    "do_not_proceed": RGBColor(0xFF, 0x3B, 0x3B),
}
